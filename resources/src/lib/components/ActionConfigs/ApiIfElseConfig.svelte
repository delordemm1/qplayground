...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
      <div>
        ...
        <Input
          ...
          placeholder="runtime.api_response.status"
          required
        />
        <p class="text-xs text-gray-500 mt-1">
          Path to the runtime variable (e.g., runtime.user.id, runtime.api_response.data[0].status)
        </p>
      </div>
      <div>
      ...
      <div class="space-y-4">
        {#each config.else_if_conditions as elseIfCondition, conditionIndex (conditionIndex)}
          <div class="border p-4 rounded-md bg-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="runtime.api_response.error_code"
                  required
                />
              </div>
              <div>
            ...
            {#if !["is_null", "is_not_null", "is_true", "is_false"].includes(elseIfCondition.condition_type)}
              <div class="mb-4">
  ...
  <div class="border p-4 rounded-md bg-blue-50 border-blue-200">
    ...
    <div class="text-sm text-blue-700 space-y-2">
      <p><strong>Scenario:</strong> Check API response status and handle different cases</p>
      <p><strong>Variable Path:</strong> <code>runtime.api_response.status</code></p>
      <p><strong>Main Condition:</strong> equals "success"</p>
      <p><strong>Else If:</strong> runtime.api_response.error_code equals "404"</p>
      <p><strong>Else:</strong> Handle any other error cases</p>
      <p><strong>Final:</strong> Always log the completion</p>
    </div>
  </div>
</div>
